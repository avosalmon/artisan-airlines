...
import { createInertiaApp, Head, Link, useForm, usePage } from "@inertiajs/react";
...
import { Fragment as Fragment$1, useEffect, useRef, useState } from "react";
                ...
                children: [
                  /* @__PURE__ */ jsx("div", {
                    ...
                    children: /* @__PURE__ */ jsx(ApplicationLogo, {
                      className: "size-10 fill-current text-black dark:text-white",
                    }),
                  }),
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", {
              ...
              children: /* @__PURE__ */ jsxs(Button, {
                className: "w-full",
                disabled: processing,
                children: [processing && /* @__PURE__ */ jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }), "Confirm Password"],
              }),
            }),
          ],
        }),
      ...
      /* @__PURE__ */ jsxs("form", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            children: ["Don't have an account?", " ", /* @__PURE__ */ jsx(TextLink, { href: route("register"), tabIndex: 4, children: "Sign up" })],
          }),
        ],
      }),
    ],
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs("form", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", {
            className: "text-center text-sm",
            children: ["Already have an account?", " ", /* @__PURE__ */ jsx(TextLink, { href: route("login"), tabIndex: 6, children: "Log in" })],
          }),
        ],
      }),
    ],
        ...
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs(Button, {
              ...
              className: "w-full",
              disabled: processing,
              children: [processing && /* @__PURE__ */ jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }), "Reset Password"],
            }),
          ],
        }),
      }),
      ...
      /* @__PURE__ */ jsx("form", {
        ...
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [
            /* @__PURE__ */ jsxs(Button, {
              disabled: processing,
              children: [processing && /* @__PURE__ */ jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }), "Resend Verification Email"],
            }),
            /* @__PURE__ */ jsx(Link, {
              href: route("logout"),
              method: "post",
...
const Separator = React.forwardRef(({ className, orientation = "horizontal", decorative = true, ...props }, ref) =>
  /* @__PURE__ */ jsx(SeparatorPrimitive.Root, {
    ref,
    decorative,
    orientation,
...
const SheetOverlay = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx(SheetPrimitive.Overlay, {
    className: cn(
      ...
      /* @__PURE__ */ jsxs(SheetPrimitive.Content, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(SheetPrimitive.Close, {
            ...
            children: [/* @__PURE__ */ jsx(X, { className: "h-4 w-4" }), /* @__PURE__ */ jsx("span", { className: "sr-only", children: "Close" })],
          }),
        ],
      }),
    ],
...
const SheetTitle = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx(SheetPrimitive.Title, { ref, className: cn("text-lg font-semibold text-foreground", className), ...props }),
);
SheetTitle.displayName = SheetPrimitive.Title.displayName;
const SheetDescription = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx(SheetPrimitive.Description, { ref, className: cn("text-sm text-muted-foreground", className), ...props }),
);
...
const SidebarTrigger = React.forwardRef(({ className, onClick, ...props }, ref) => {
  ...
  return /* @__PURE__ */ jsxs(Button, {
    ...
    ...props,
    children: [/* @__PURE__ */ jsx(PanelLeft, {}), /* @__PURE__ */ jsx("span", { className: "sr-only", children: "Toggle Sidebar" })],
  });
});
...
const SidebarGroupContent = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx("div", { ref, "data-sidebar": "group-content", className: cn("w-full text-sm", className), ...props }),
);
SidebarGroupContent.displayName = "SidebarGroupContent";
const SidebarMenu = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx("ul", { ref, "data-sidebar": "menu", className: cn("flex w-full min-w-0 flex-col gap-1", className), ...props }),
);
SidebarMenu.displayName = "SidebarMenu";
const SidebarMenuItem = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx("li", { ref, "data-sidebar": "menu-item", className: cn("group/menu-item relative", className), ...props }),
);
            ...
            SidebarMenuItem,
            {
              children: /* @__PURE__ */ jsx(SidebarMenuButton, {
                ...
                children: /* @__PURE__ */ jsxs("a", {
                  ...
                  children: [/* @__PURE__ */ jsx(item.icon, { className: "" }), /* @__PURE__ */ jsx("span", { children: item.title })],
                }),
              }),
            },
            item.title,
...
const AvatarImage = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx(AvatarPrimitive.Image, { ref, className: cn("aspect-square h-full w-full", className), ...props }),
);
  ...
  /* @__PURE__ */ jsxs(DropdownMenuPrimitive.RadioItem, {
    ...
    children: [
      /* @__PURE__ */ jsx("span", {
        className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center",
        children: /* @__PURE__ */ jsx(DropdownMenuPrimitive.ItemIndicator, {
          children: /* @__PURE__ */ jsx(Circle, { className: "h-2 w-2 fill-current" }),
        }),
      }),
      children,
    ],
...
const DropdownMenuSeparator = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx(DropdownMenuPrimitive.Separator, { ref, className: cn("-mx-1 my-1 h-px bg-muted", className), ...props }),
);
            ...
            children: [
              /* @__PURE__ */ jsx(DropdownMenuLabel, {
                ...
                children: /* @__PURE__ */ jsx("div", {
                  ...
                  children: /* @__PURE__ */ jsx(UserInfo, { user: auth.user }),
                }),
              }),
...
function AppearanceToggleTab({ className = "", ...props }) {
  ...
  return /* @__PURE__ */ jsx("div", {
    className: `inline-flex gap-1 rounded-lg bg-neutral-100 p-1 dark:bg-neutral-800 ${className}`,
    ...props,
    children: tabs.map(({ value, icon: Icon, label }) =>
      /* @__PURE__ */ jsxs(
        "button",
        {
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", {
            ...
            children: /* @__PURE__ */ jsx("section", { className: "max-w-xl space-y-12", children }),
          }),
        ],
      }),
    ],
...
const DialogHeader = ({ className, ...props }) =>
  /* @__PURE__ */ jsx("div", { className: cn("flex flex-col space-y-1.5 text-center sm:text-left", className), ...props });
DialogHeader.displayName = "DialogHeader";
const DialogFooter = ({ className, ...props }) =>
  /* @__PURE__ */ jsx("div", { className: cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2", className), ...props });
DialogFooter.displayName = "DialogFooter";
const DialogTitle = React.forwardRef(({ className, ...props }, ref) =>
  /* @__PURE__ */ jsx(SheetPrimitive.Title, { ref, className: cn("text-lg font-semibold leading-none tracking-tight", className), ...props }),
);
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", {
            className: "relative ml-3 text-red-600 dark:text-red-100",
            children: [
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("a", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxs("div", {
                            className: "relative flex items-center gap-6 lg:items-end",
                            children: [
                              /* @__PURE__ */ jsxs("div", {
                      ...
                      /* @__PURE__ */ jsxs("div", {
                        className:
                          "flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] dark:bg-zinc-900 dark:ring-zinc-800 lg:pb-10",
                        children: [
                          /* @__PURE__ */ jsx("div", {
                            className: "flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16",
                            children: /* @__PURE__ */ jsx("svg", {
