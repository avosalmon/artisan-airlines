...
export default function Index({ flights, passengers }: PageProps<{ flights: Flight[]; passengers: number }>) {
  ...
  return (
    <FormLayout>
      ...
      <div className="container mx-auto -mt-4 max-w-screen-md px-4 py-8">
        {/* Title */}
        <div className="motion-preset-blur-up mb-8 flex items-center justify-between">
        ...
        <div className="space-y-8">
          {flights.map((flight, index) => (
            <FlightCard
              ...
              onSelectFlight={createPendingBooking}
              className={`motion-preset-blur-up delay-[${index * 150}ms]`}
            />
          ))}
        </div>
      </div>
